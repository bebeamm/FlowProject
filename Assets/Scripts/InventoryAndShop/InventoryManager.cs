...
public class InventoryManager : MonoBehaviour
{
    ...
    [SerializeField] private Item pandan;
    ...
    public int GetPandan => pandan.Amount;
    ...
    public void AddPandan(int amount) => pandan.Amount += amount;
    ...
    public void RemovePandan(int amount) => pandan.Amount -= amount;
    public void RemovePaper(int amount) => paper.Amount -= amount;
    public void RemoveTape(int amount) => tape.Amount -= amount;
    public void RemovePaperBag(int amount) => paperBag.Amount -= amount;
